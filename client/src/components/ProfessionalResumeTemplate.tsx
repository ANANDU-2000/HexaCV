 ...
 */
export default function ProfessionalResumeTemplate({
  resume,
    ...
    <div className="bg-white text-slate-900 p-8 md:p-12 max-w-4xl mx-auto font-sans leading-relaxed">
      ...
      {experienceSection?.visible && experienceSection?.content.experiences && (
        <div className="mb-6">
          ...
          <div className="space-y-4">
            {experienceSection.content.experiences.map(
              (exp: any, idx: number) => (
                <div key={idx}>
                  ...
                  {exp.description && (
                    <ul className="mt-2 space-y-1 ml-4">
                      {(Array.isArray(exp.description)
                        ...
                        <li
                          key={i}
                          className="text-sm text-slate-700 list-disc"
                        >
                          {bullet}
                        </li>
                      ))}
      ...
      {educationSection?.visible && educationSection?.content.educations && (
        <div className="mb-6">
          ...
          <div className="space-y-2">
            {educationSection.content.educations.map(
              (edu: any, idx: number) => {
                const cleanField = (() => {
                  if (!edu.field) return "";
      ...
      {certificationsSection?.visible &&
        certificationsSection?.content.certifications && (
          <div className="mb-6">
            ...
            <div className="space-y-2">
              {certificationsSection.content.certifications.map(
                (cert: any, idx: number) => (
